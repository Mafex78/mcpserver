...
namespace McpServer.ProductBox;
...
public class ProductTools
{
    ...
    public string SearchProducts(
        [Description("Search keyword. Matches against product name and category. Example: 'keyboard', 'office', 'USB'")] string keyword)
    {
    ...
    public string GetProduct(
        [Description("Exact product SKU code, e.g. 'KBD-001'. Case-insensitive.")] string sku)
    {
